...
COMPARISON_DATA = pd.read_csv('data/12-22_suisse_sect26_tout_tout.csv', sep=';')
# columns: "Année";"Grande région";"Division économique";"Position professionnelle";"Sexe";"Médiane";"P10";"P25";"P75";"P90"
...
class ComparisonsView(View):
    ...
    def renderComparison(self, series, region, position, year):
        ...
        if series == Series.POSITION:
            mask = mask & (COMPARISON_DATA["Position professionnelle"] == position)
